...
@ApplicationScoped
public class InternationalizedStringRepository {

    @Inject
    private EntityManager em;

    public InternationalizedString findById(Long id) throws NoResultException {
        InternationalizedString internationalizedString = em.find(InternationalizedString.class, id);
